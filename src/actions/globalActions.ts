...
const MESSAGE_APP_DATA_LOADING_STARTED = 'MESSAGE_APP_DATA_LOADING_STARTED';
const MESSAGE_APP_DATA_LOADING_ENDED = 'MESSAGE_APP_DATA_LOADING_ENDED';

const CHANNELS_RETRIEVING_STARTED = 'CHANNELS_RETRIEVING_STARTED';
